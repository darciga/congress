    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placeOrigin', models.CharField(help_text=b'Company or institute', max_length=180, verbose_name=b'Place of origin')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=90, verbose_name='City')),
                ('telephone', models.CharField(max_length=30, verbose_name='Telephone')),
                ('company', models.CharField(help_text=b'Company or institution', max_length=160, verbose_name=b'Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hourEnd', models.CharField(max_length=10, verbose_name='Hour end')),
                ('place', models.CharField(max_length=40, verbose_name='Place')),
                ('rapporteur', models.ForeignKey(related_name=b'Rapporteur', to='congress.Rapporteur')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='rapporteur',
            field=models.ForeignKey(related_name=b'Lecturer', to='congress.Rapporteur'),
